...
"Alabama": { center: [-86.8287,32.7794], zoom: 12 },
"Alaska": { center: [-152.2782,64.0685], zoom: 1.5 },
"Arizona": { center: [-111.6602,34.2744], zoom: 10 },
"Arkansas": { center: [-92.4426,34.8938], zoom: 10 },
"California": { center: [-119.4696,37.1841], zoom: 6 },
"Colorado": { center: [-105.5478,38.9972], zoom: 10 },
"Connecticut": { center: [-72.7273,41.6219], zoom: 10 },
"Delaware": { center: [-75.505,38.9896], zoom: 10 },
"District of Columbia": { center: [-77.0147,38.9101], zoom: 10 },
"Florida": { center: [-82.4497,28.6305], zoom: 10 },
"Georgia": { center: [-83.4426,32.6415], zoom: 10 },
"Hawaii": { center: [-156.3737,20.2927], zoom: 10 },
"Idaho": { center: [-114.613,44.3509], zoom: 10 },
"Illinois": { center: [-89.1965,40.0417], zoom: 10 },
"Indiana": { center: [-86.2816,39.8942], zoom: 10 },
"Iowa": { center: [-93.496,42.0751], zoom: 10 },
"Kansas": { center: [-98.3804,38.4937], zoom: 10 },
"Kentucky": { center: [-85.3021,37.5347], zoom: 10 },
"Louisiana": { center: [-91.9968,31.0689], zoom: 10 },
"Maine": { center: [-69.2428,45.3695], zoom: 10 },
"Maryland": { center: [-76.7909,39.055], zoom: 10 },
"Massachusetts": { center: [-71.8083,42.2596], zoom: 10 },
"Michigan": { center: [-85.4102,44.3467], zoom: 10 },
"Minnesota": { center: [-94.3053,46.2807], zoom: 10 },
"Mississippi": { center: [-89.6678,32.7364], zoom: 10 },
"Missouri": { center: [-92.458,38.3566], zoom: 10 },
"Montana": { center: [-109.6333,47.0527], zoom: 10 },
"Nebraska": { center: [-99.7951,41.5378], zoom: 10 },
"Nevada": { center: [-116.6312,39.3289], zoom: 10 },
"New Hampshire": { center: [-71.5811,43.6805], zoom: 10 },
"New Jersey": { center: [-74.6728,40.1907], zoom: 10 },
"New Mexico": { center: [-106.1126,34.4071], zoom: 10 },
"New York": { center: [-75.5268,42.9538], zoom: 10 },
"North Carolina": { center: [-79.3877,35.5557], zoom: 17 },
"North Dakota": { center: [-100.4659,47.4501], zoom: 10 },
"Ohio": { center: [-82.7937,40.2862], zoom: 10 },
"Oklahoma": { center: [-97.4943,35.5889], zoom: 10 },
"Oregon": { center: [-120.5583,43.9336], zoom: 10 },
"Pennsylvania": { center: [-77.7996,40.8781], zoom: 10 },
